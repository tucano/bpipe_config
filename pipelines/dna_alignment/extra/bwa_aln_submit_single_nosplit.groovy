about title: "DNA alignment with bwa aln+samse [deprecated]"
// INFO_USAGE: bpipe-config pipe bwa_aln_submit_single_nosplit (CWD)
// INFO_USAGE: bpipe-config pipe bwa_aln_submit_single_nosplit Sample_* (runner.sh)
...
Bpipe.run {
    set_stripe_gfu +
    "%_R*" * [align_bwa_gfu.using(paired:false,compression:"gz",BWAOPT_ALN:"",BWAOPT_SE:"")] +

 ...
 *
 *  This is a complex pipeline that requires a lot of variables/configurations, see descriptions of varables/grpoups of variables
 *
 *  OUTPUTS:
 *  1. report.html file (AUTOGENERATED)
 *  2. a script to rebuild the rport with knitr on the server

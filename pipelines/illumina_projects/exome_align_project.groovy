...
Bpipe.run {
    ...
    ] + "%.bam" * [move_sample_results.using(result_dir:"BAM") + calculate_hsmetrics_gfu.using(output_dir:"HsMetrics") ] +
    "*.hsmetrics" * [make_report_hsmetrics_gfu.using(output_dir:"doc")]
}

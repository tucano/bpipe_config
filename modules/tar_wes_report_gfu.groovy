...
tar_wes_report_gfu =
{
  ...
  produce("report.tar.gz")
  {
    ...
    def command = """
      ...
      tar -czvf $output SampleSheet.csv $input.Rmd $REPORT_DATA_DIR report.css Style.R README BAM_RECALIBRATION_SCHEMA.png VARIANTS_CALLING_SCHEMA.png VARIANTS_ANNOTATION_SCHEMA.png;
    """
